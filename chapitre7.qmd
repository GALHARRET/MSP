...
L'analyse en compsante principale (ACP) est une méthode factorielle qui permet de réduire la dimension d'une matrice en résumant les caractéristiques à travers des combinaisons linéaires de celles-ci (appelées composantes principales). Elle est particulièrement indiquée lorsque la corrélation entre les caractéristiques est forte.
